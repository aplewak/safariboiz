...
class GetDetailTextForScaling extends Component {
  ...
  render() {
    ...
    <Collapse isOpened={this.props.scalingTextisOpen}>
      <div className="sft">
          <center>
          <b><h4>Overview :</h4> </b> Rescaling the axis are there so that at certain load ranges we can properly  
          <b><h5>When tuning past stage 3 read below (for most cases)</h5> </b> 
